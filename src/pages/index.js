  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Kriptovalyutada daromad qilishni o'rganing, Biz bilan birgalikda dunyoning istalgan nuqtasidan turib pul ishlang"
        />
        <meta
          name="keywords"
          content="arashov, online, kripto, cripto, pul, soqqa, trader, traderlik, treydirlik, arashov o'rgatish, o'rganish, traderlik darslari, cripto o'qish, arashovonline"
        />
        <link
          rel="shortcut icon"
      ...
      <main>
        ...
        <div className="pt-20">
          <div className="relative z-10">
            <p className="mezzardBold boxTitle competition__title">
              TRADINGNI MUKAMMAL O’RGANMOQCHI BO’SANGIZ
            </p>
            <p className="mezzardBold boxTitle text-center">
          ...
          <div className="mt-[50px]">
            ...
            <div className="flex justify-center relative z-10">
              <div className="gridsss bg-[#031026] border-[#3A7EFF] border-2 p-[40px] rounded-[35px]">
